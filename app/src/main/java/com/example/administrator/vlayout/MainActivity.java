...
public class MainActivity extends AppCompatActivity implements MyItemClickListener {
    ...
    MyAdapter Adapter_linearLayout,
            Adapter_GridLayout,
            Adapter_FixLayout,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 创建自定义的Adapter对象 & 绑定数据 & 绑定对应的LayoutHelper进行布局绘制
         Adapter_linearLayout  = new MyAdapter(this, linearLayoutHelper, 20, listItem) {
...
//        }
        ...
        floatLayoutHelper.setDefaultLocation(400, 300);// 设置布局里Item的初始位置
